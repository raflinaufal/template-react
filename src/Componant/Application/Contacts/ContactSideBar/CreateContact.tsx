...
import { ContactUsersType } from '../../../../Types/Application/Contacts';
...
const CreateContact = () => {
  ...
  return (
    <>
      <Btn block className="badge-light-primary w-100 btn-mail" color="transparent" onClick={toggle}>
      ...
      <Modal className="modal-bookmark" isOpen={modal} toggle={toggle} size="lg">
        ...
        <ModalBody>
          <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(AddContact)}>
            ...
            <Btn color="secondary" className='me-1' type="submit" onClick={() => dispatch(setContactValidation(true))}>{Save}</Btn>
