  ...
  return (
    <Form className="theme-form form-label-align-right range-slider">
      <FormGroup>
        <Row className="py-1">
          <Col md="10">
            <div style={{ color: "var(--theme-deafult)" }} className="d-flex justify-content-center flex-wrap m-3">
              <Range
                values={values}
                step={1}
                min={100}
                ...
                renderThumb={({ props, index }) => (
                  ...
                  >
                    <div style={{ height: "20px", width: "5px", backgroundColor: "var(--theme-deafult)" }} />
                  </div>
                )}
              />
