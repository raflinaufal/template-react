...
import EcommerceDashborad from "../Pages/Dashboard/Ecommerce/EcommerceDashborad";
...
import Grid from "../Pages/Ui-Kits/Grid";
...
import Lists from "../Pages/Ui-Kits/Lists";
import Accordion from "../Pages/Ui-Kits/Accordion";
import BootstrapTabs from "../Pages/Ui-Kits/BootstrapTabs";
import Dropdown from "../Pages/Ui-Kits/Dropdown";
import Alert from "../Pages/Ui-Kits/Alert";
import Popover from "../Pages/Ui-Kits/Popover";
import Tooltip from "../Pages/Ui-Kits/Tooltip";
import Modal from "../Pages/Ui-Kits/Modal";
import TagAndPills from "../Pages/Ui-Kits/TagAndPills";
import Progress from "../Pages/Ui-Kits/Progress";
...
const routes = [
  ...
  },
  {
    ...
    Component: <EcommerceDashborad />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/education`,
  ...
  // Page Layout
  {
    path: `${process.env.PUBLIC_URL}/page_layout/hide_nav_scroll`,
    Component: <HideNavScrollContainer />,
  },

  // Project
  {
    path: `${process.env.PUBLIC_URL}/project/project_list`,
    Component: <ProjectList />,
  },
  {
    path: `${process.env.PUBLIC_URL}/project/create_new`,
    Component: <ProjectCreate />,
  },

  // File Manager
  {
    path: `${process.env.PUBLIC_URL}/app/file_manager`,
    Component: <FileManager />,
  },

  // Ecommerce
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/add_product`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/product_page`,
    Component: <ProductPage />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/product_list`,
    Component: <ProductList />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/payment_details`,
    Component: <PaymentDetails />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/order_history`,
  ...
  // LetterBox
  {
    path: `${process.env.PUBLIC_URL}/email/letter_box`,
    Component: <LetterBox />,
  },

  // Chat
  {
    path: `${process.env.PUBLIC_URL}/chat/private_chat`,
    Component: <PrivateChat />,
  },
  {
    path: `${process.env.PUBLIC_URL}/chat/group_chat`,
    Component: <GroupChat />,
  },

  // Users
  {
    path: `${process.env.PUBLIC_URL}/users/user_profile`,
    Component: <UsersProfile />,
  },
  {
    path: `${process.env.PUBLIC_URL}/users/user_edit`,
  ...
  // Calender
  { path: `${process.env.PUBLIC_URL}/app/calendar`, Component: <Calender /> },

  // SocialApp
  {
    path: `${process.env.PUBLIC_URL}/app/social_app`,
    Component: <SocialApp />,
  },
  ...
  // SearchResult
  {
    path: `${process.env.PUBLIC_URL}/app/search_result`,
    Component: <SearchResult />,
  },

  // Forms Control
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/form_validation`,
    Component: <FormsValidation />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/base_input`,
    Component: <BaseInput />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/radio_checkbox`,
    Component: <RadioCheckbox />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/input_groups`,
    Component: <InputGroup />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/input_mask`,
    Component: <InputMask />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_controls/mega_option`,
    Component: <MegaOption />,
  },

  // Forms Widgets
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_widget/datepicker`,
    Component: <DatePicker />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_widget/touchspin`,
    Component: <TouchSpin />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_widget/switch`,
    Component: <Switch />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_widget/typeahead`,
    Component: <Typeahead />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_widget/clipboard`,
    Component: <ClipBoard />,
  },

  // Forms Layout
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_layout/form_wizard_1`,
    Component: <FormWizardOne />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_layout/form_wizard_2`,
    Component: <FormWizardTwo />,
  },
  {
    path: `${process.env.PUBLIC_URL}/forms/forms_layout/two_factor`,
    Component: <TwoFactor />,
  },
  ...
  // Data Tables
  {
    path: `${process.env.PUBLIC_URL}/table/data_table/basic_init`,
    Component: <BasicInit />,
  },
  {
    path: `${process.env.PUBLIC_URL}/table/data_table/advance_init`,
    Component: <AdvanceInit />,
  },
  {
    path: `${process.env.PUBLIC_URL}/table/data_table/api`,
    Component: <ApiDataTable />,
  },
  {
    path: `${process.env.PUBLIC_URL}/table/data_table/data_sources`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/bonusui/tree_view`,
    Component: <TreeView />,
  },
  ...
  {
    path: `${process.env.PUBLIC_URL}/bonusui/sweet_alert2`,
    Component: <SweetAlert />,
  },
  {
    path: `${process.env.PUBLIC_URL}/bonusui/owl_carousel`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/bonusui/range_slider`,
    Component: <RangeSlider />,
  },
  {
    path: `${process.env.PUBLIC_URL}/bonusui/image_cropper`,
    Component: <ImageCropper />,
  },
  {
    path: `${process.env.PUBLIC_URL}/bonusui/basic_cards`,
    Component: <BasicCard />,
  },
  {
    path: `${process.env.PUBLIC_URL}/bonusui/creative_cards`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/icons/themify_icon`,
    Component: <ThemifyIcons />,
  },
  {
    path: `${process.env.PUBLIC_URL}/icons/feather_icon`,
    Component: <FeatherIcons />,
  },
  {
    path: `${process.env.PUBLIC_URL}/icons/weather_icon`,
    Component: <WhetherIcon />,
  },

  // Buttons
  {
    path: `${process.env.PUBLIC_URL}/buttons/default_style`,
    Component: <DefaultStyle />,
  },
  {
    path: `${process.env.PUBLIC_URL}/buttons/flat_style`,
    Component: <FlatStyle />,
  },
  {
    path: `${process.env.PUBLIC_URL}/buttons/edge_style`,
    Component: <EdgeStyle />,
  },
  {
    path: `${process.env.PUBLIC_URL}/buttons/raised_style`,
    Component: <RaisedStyle />,
  },
  {
    path: `${process.env.PUBLIC_URL}/buttons/button_group`,
    Component: <ButtonGroup />,
  },

  // Charts
  {
    path: `${process.env.PUBLIC_URL}/charts/apex_chart`,
    Component: <ApexChart />,
  },
  {
    path: `${process.env.PUBLIC_URL}/charts/google_chart`,
    Component: <GoogleChart />,
  },
  {
    path: `${process.env.PUBLIC_URL}/charts/chartjs_chart`,
    Component: <ChartJs />,
  },
  ...
  // Gallery
  {
    path: `${process.env.PUBLIC_URL}/gallery/gallery_grids`,
    Component: <GalleryGrid />,
  },
  {
    path: `${process.env.PUBLIC_URL}/gallery/gallery_grid_desc`,
    Component: <GalleryGridDesc />,
  },
  {
    path: `${process.env.PUBLIC_URL}/gallery/masonry_gallery`,
    Component: <MasonryGallery />,
  },
  {
    path: `${process.env.PUBLIC_URL}/gallery/masonry_with_desc`,
    Component: <MasonryImageDesc />,
  },
  {
    path: `${process.env.PUBLIC_URL}/gallery/hover_effect`,
    Component: <HoverEffect />,
  },

  // Blog
  {
    path: `${process.env.PUBLIC_URL}/blog/blog_details`,
    Component: <BlogDetails />,
  },
  {
    path: `${process.env.PUBLIC_URL}/blog/blog_single`,
    Component: <BlogSingle />,
  },
  { path: `${process.env.PUBLIC_URL}/blog/add_post`, Component: <AddPost /> },

  // Faq
  { path: `${process.env.PUBLIC_URL}/fag/faq`, Component: <Faq /> },

  // Job Search
  {
    path: `${process.env.PUBLIC_URL}/job_search/card_view`,
    Component: <CardView />,
  },
  {
    path: `${process.env.PUBLIC_URL}/job_search/list_view`,
    Component: <ListView />,
  },
  {
    path: `${process.env.PUBLIC_URL}/job_search/job_detail`,
    Component: <JobDetails />,
  },
  {
    path: `${process.env.PUBLIC_URL}/job_search/apply`,
    Component: <JobApply />,
  },

  // Learning
  {
    path: `${process.env.PUBLIC_URL}/learning/learning_list`,
    Component: <LearningList />,
  },
  {
    path: `${process.env.PUBLIC_URL}/learning/learning_course`,
    Component: <DetailsCourse />,
  },

  // Maps
  {
    path: `${process.env.PUBLIC_URL}/map/google_map`,
    Component: <GoogleMap />,
  },
  {
    path: `${process.env.PUBLIC_URL}/map/leaflet_map`,
    Component: <LeafletMaps />,
  },

  // Editor
  {
    path: `${process.env.PUBLIC_URL}/editor/ck_editor`,
    Component: <CkEditor />,
  },
  {
    path: `${process.env.PUBLIC_URL}/editor/mde_editor`,
    Component: <MdeEditor />,
  },
  {
    path: `${process.env.PUBLIC_URL}/editor/ace_editor`,
    Component: <AceEditor />,
  },
  ...
  // Support Ticket
  {
    path: `${process.env.PUBLIC_URL}/support_ticket/support_ticket`,
